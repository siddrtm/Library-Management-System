...
<%-- 				    <% resultset.next(); %> --%>
		 ...
		 <div id="templatemo_content_center">
			...
			<%  ResultSet rs_overdue = (ResultSet) request.getAttribute("rs");
			//System.out.println(rs_overdue.getString(1));
				...
				%>
				 <TABLE style="position: absolute;left: 450px;top: 550px">
				    ...
				    <% while(rs_overdue.next()){ %>
				    <TR>
				        <TD> <%= rs_overdue.getString(1) %></td>
				        <TD> <%= rs_overdue.getString(2) %></TD>
				        <TD> <%= rs_overdue.getString(3) %></TD>
				        <TD> <%= rs_overdue.getString(4) %></TD>
				        <TD> <%= rs_overdue.getString(5) %></TD>
				        <TD> <%= rs_overdue.getString(6) %></TD>
				        <TD> <%= rs_overdue.getString(7) %></TD>
				        
				        <TD> <%= fine.calcFine(rs_overdue.getString(7)) %></TD>
