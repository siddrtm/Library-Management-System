...
<%-- 				    <% resultset.next(); %> --%>
		 ...
		 <div id="templatemo_content_center">
        	<div >
				...
				switch(flag)
				{
				case 0: out.println("Issued successfully");break;
				case 1: out.println("No book with entered media ID");break;
				case 2: out.println("Max no of books already issued to the user");break;
				case 3: out.println("Book already issued");break;
				}
				%>
