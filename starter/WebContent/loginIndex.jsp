      ...
      <div id="templatemo_content_left">
        	<div class="templatemo_content_left_section">
                ...
                <ul>
                    ...
                    <li><a href="basic_search.php">Basic Catalouge Search</a></li>
					 <li><a href="advanced_search.php">Advanced Catalouge Search</a></li>
                    <li><a href="#">Latest Arrivals</a></li>
                    <li><a href="http://in.news.yahoo.com/">Yahoo News</a></li>
            	</ul>
            </div>
			<div class="templatemo_content_left_section">
            	<h1>Newspapers</h1>
