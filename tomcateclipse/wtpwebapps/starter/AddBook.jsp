...
<%-- 				    <% resultset.next(); %> --%>
        	...
        	<div id="templatemo_content_center">
					...
					<s:form action="AddBook" method= "post">
						 ...
						 <s:textfield name="b_id"  label="Book id"/>
						 ...
						 <s:textfield name="shelfNo"  label="Shelf No"/>
						 <s:textfield name="edition"  label="Edition"/>
						 <s:textfield name="noOfPages"  label="No of Pages"/>
						 
						 						
						<s:select name="subject" label="Subject:" list="{'Art','Architecture','Astrophysics','Autobiography','Astronomy','Biology','Chemistry','Engineering','EngineeringMathematics'}">
						 
						
						</s:select>
						 
						
						<s:select name="language" label="Language:" list="{'Arabic','Assamese','English','French','Russian','Punjabi','Others','Multi'}">
						
						</s:select>
						       
						
						
					    <s:textfield name="author1"  label="Author:"/> 
								 <s:textfield name="author2"  /> 
								 <s:textfield name="author3"  />
						
						<s:textfield name="tag1"  label="Search TAGS:"/> 
								 <s:textfield name="tag2"  /> 
								 <s:textfield name="tag3"  />	
								 <s:textfield name="tag4"  /> 
								 <s:textfield name="tag5"  /> 
								 <s:textfield name="tag6"  /> 
