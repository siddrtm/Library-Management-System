...
<%-- 				    <% resultset.next(); %> --%>
	    ...
	    <s:form action="ResetPassword" method= "post">
							...
							<s:password name="oldPass" label="Enter Old Password" />
							<s:password name="newPass" label="Enter New Password"/>
							<s:password name="renewPass" label="Confirm New Password"/>
					 		<s:submit name="changePass" value="Change Password" />
